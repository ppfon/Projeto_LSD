...
-- menor	=>  Location: PIN_B11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- b[0]	=>  Location: PIN_C11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- b[1]	=>  Location: PIN_G12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default


ARCHITECTURE structure OF Comp2Bits IS
...
-- Equation(s):
-- \LessThan0~0_combout\ = (\b~combout\(1) & (\a~combout\(1) & (!\b~combout\(0) & \a~combout\(0)))) # (!\b~combout\(1) & ((\a~combout\(1)) # ((!\b~combout\(0) & \a~combout\(0)))))
...
-- Equation(s):
-- \LessThan1~0_combout\ = (\b~combout\(1) & (((\b~combout\(0) & !\a~combout\(0))) # (!\a~combout\(1)))) # (!\b~combout\(1) & (!\a~combout\(1) & (\b~combout\(0) & !\a~combout\(0))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (\b~combout\(1) & ((\b~combout\(0) $ (\a~combout\(0))) # (!\a~combout\(1)))) # (!\b~combout\(1) & ((\a~combout\(1)) # (\b~combout\(0) $ (\a~combout\(0)))))
